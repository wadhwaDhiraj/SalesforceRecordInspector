...
exports.LogHistoryService = void 0;
class LogHistoryService {
    static parseLog(logContent, variableName) {
        const versions = [];
        ...
        for (const line of lines) {
            ...
            if (!line.includes(variableName) || !line.includes("VARIABLE_ASSIGNMENT"))
                continue;
...
exports.LogHistoryService = LogHistoryService;
//# sourceMappingURL=logHistoryService.js.map